    ...
    <div class="field">
        ...
        <div class="field__date">
            <div class="field__date-inputs">
                <input class="field__date-input" type="text" placeholder="ДД" readonly v-model="dateDay" />
                <input class="field__date-input" type="text" placeholder="ММ" readonly v-model="dateMonth" />
                <input class="field__date-input field__date-input--year" type="text" placeholder="ГГГГ" readonly
                    v-model="dateYear" />
            </div>
            <input class="field__date-picker" type="text" readonly required ref="pickerInput" />
        </div>
